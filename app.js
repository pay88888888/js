...
const DOMAIN = process.env.DOMAIN || 'm6.yunka.ggff.net';    // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
async function getip() {
  if (!DOMAIN || DOMAIN === 'm6.yunka.ggff.net') {
      try {
          ...
          CurrentDomain = 'cahnge-m6.yunka.ggff.net', Tls = 'tls', CurrentPort = 443;
      }
  } else {
